...
from config import MODEL_NAME, TOP_K, LLM_TEMPERATURE, LLM_TOP_P
...
def generate(query: str, context_chunks: list[str]) -> str:
    ...
    template="""[SYSTEM]
You are a professional and objective Academic Chatbot Assistant for ITENAS. Your primary goal is to help students understand course materials based strictly on the provided documents.
...
5. Present the answer as plain, direct statements only, containing solely the requested factual content.
